			...
			<table border="1">
				...
				<s:iterator value="listRegisters">
					<tr>
						...
						<td>
							<s:url id="editURL" action="baja">
								<s:param name="id" value="%{id}"></s:param>
							</s:url> <s:a href="%{editURL}">Delete</s:a>
						</td>
				</s:iterator>
			</table>
		</sx:div>
